...
<body background="Images/MyBackground.png" bgcolor="#FFCC99">
    ...
    <?php
        ...
        include ("connect.php");
        $p = mysql_query("UPDATE wishlist SET name='".$name."', onsale='".$_POST['txtonsale']."', price='".$_POST['txtprice']."', description='".trim($_POST['txtdescription'])."', category='".$_POST['txtcategory']."', date='".$_POST['txtdate']."' WHERE id='".$id."'");
        if($p==true){
