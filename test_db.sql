...
-- Database: `test_db`
--
CREATE DATABASE IF NOT EXISTS `id1098792_test_db` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `id1098792_test_db`;
...
INSERT INTO `wishlist` (`txtid`, `name`, `onsale`, `price`, `description`, `category`, `date`) VALUES
